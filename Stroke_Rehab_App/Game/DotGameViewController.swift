...
class DotGameViewController: UIViewController {
    ...
    //This are for the timer of the game
    ...
    var timer = Timer()
    var timeLimit = 0   //This is for the time limit of the game
    ...
    func intialiseGame()
    {
        ...
        if getRepNum != 0 {
            repNum = getRepNum
            repetition.text = "Repetitions: \(repCount)/\(repNum)"
        }
        else{
            repNum = 2
            defaultSetting.set(repNum, forKey: "RepNumber") //This saves the repetition number if the user doesn't save the settings.
            repetition.text = "Repetitions: \(repCount)/\(repNum)"
        }
    ...
    */
    @objc func timerClass(){
        ...
        clock.text = makeTimeString(minutes: time.0, seconds: time.1)
        
        if(timeLimit == 0){
            timer.invalidate()
            clock.text = "Time: 00:00 min(s)"
            ...
            */
            ...
            self.performSegue(withIdentifier: "DotGameCompSegue", sender: self) //This sends the user to the game complete page.
        }
    }
    ...
    // MARK: - Save Time and Button Press
    //This function saves the duration and button press of the game
    func saveTimeButton()
    {
        defaultSetting.set(differ, forKey: "DurationSecond")
        defaultSetting.set(buttonCount, forKey: "ButtonPress")
    }
    
    // MARK: - Update Repetition
    ...
    func gameComplete()
    {
        print("repCount = \(repCount) and numRep = \(repNum + 1)")
        if repCount == (repNum + 1)
        {
            ...
            */
            ...
            pauseClock() //This stops the timer
            storeToDatabase() //This saves to the database.
            ...
            self.performSegue(withIdentifier: "DotGameCompSegue", sender: self)
        }
        else
        {
    ...
    // MARK: - Progress Bar Special func
    ...
    */
    func randomButPos()
    {
        ...
        {
        case 1:
            print("1 Repetition track: \(repCount)")
        ...
        case 2:
            print("2 Repetition track: \(repCount)")
            //This is for moving the buttons
            UIView.animate(withDuration: 0.5, animations: {
            () in
                //These are notes for coordinates for placing the buttons
        ...
        case 3:
            print("3 Repetition track: \(repCount)")
            //This is for moving the buttons
            UIView.animate(withDuration: 0.5, animations: {
            () in
                //These are notes for coordinates for placing the buttons
        ...
        case 4:
            print("4 Repetition track: \(repCount)")
            //This is for moving the buttons
            UIView.animate(withDuration: 0.5, animations: {
            () in
                //These are notes for coordinates for placing the buttons
        ...
        case 5:
            print("5 Repetition track: \(repCount)")
            //This is for moving the buttons
            UIView.animate(withDuration: 0.5, animations: {
            () in
                //These are notes for coordinates for placing the buttons
        ...
        default:
            print("0 Repetition track: \(repCount)")
            //This is for moving the buttons
            UIView.animate(withDuration: 0.5, animations: {
            () in
                //These are notes for coordinates for placing the buttons
    ...
    // MARK: - Quit Button
    //This is for the quit button of the game
        ...
        */
        ...
        let yes = UIAlertAction(title: "Yes", style: .destructive, handler: { (action) -> Void in
            ...
            */
            ...
            self.saveTimeButton() //Saves the duration and button press of the game if the user presses the quit instead of playing the game
            self.storeToDatabase() //This saves to the database.
    ...
    func storeToDatabase()
    {
        ...
        let databaseID = dtFormatter.string(from: now)
        print("databaseID: \(databaseID)")
        
        defaultSetting.set(databaseID, forKey: "dotDatabseID") //This is for saving the DatabaseID to the userDefaults.
        ...
        ["id": databaseID,
         "gameStatus": gameOver,
         "repetitionNum": "\(repCount - 1)/\(repNum)",
         "startTime": startTime,
         "endTime": endTime,
        ...
        gameCollection.document(databaseID).setData(attempt)
        { err in
            if let err = err {
